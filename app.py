...
HOME_UNIVERSE = {
    "Restaurants": ["MCD","SBUX","CMG","YUM","QSR"],
    "Semiconductors": ["NVDA","AVGO","AMD","QCOM","MU"],
    "Software": ["MSFT","ORCL","CRM","ADBE","INTU"],
    "Technology Hardware": ["AAPL","DELL","HPE","HPQ","ANET"],
    "Internet & Digital Platforms": ["GOOGL","META","NFLX","UBER","ABNB"],
    "Banks": ["JPM","BAC","WFC","C","GS"],
    "Pharma": ["LLY","JNJ","ABBV","MRK","PFE"],
    "Energy": ["XOM","CVX","COP","EOG","SLB"],
    "Consumer Brands": ["PG","KO","PEP","PM","MDLZ"],
}
